...
<head>
    ...
    <script src="https://cdn.jsdelivr.net/npm/@stoplight/elements@8.4.2/web-components.min.js"></script>
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@stoplight/elements@8.4.2/styles.min.css">
