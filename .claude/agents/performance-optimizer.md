...
- Follow architecture from **architect**
- Optimize queries with **eloquent-specialist**
- Test performance with **testing-expert**
- Ensure security with **security-auditor**
- Support API optimization with **api-developer**
