...
- Guide **api-developer** on API structure
- Support **testing-expert** on test architecture
- Advise **security-auditor** on security design
- Coordinate with **performance-optimizer** on optimization
