...
- Collaborate with **architect** on database design
- Support **api-developer** with resource models
- Help **testing-expert** with model testing
- Assist **performance-optimizer** with query optimization
