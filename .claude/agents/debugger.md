...
- Work with **testing-expert** to create failing tests
- Collaborate with **performance-optimizer** on performance issues
- Support **eloquent-specialist** on query debugging
- Assist **security-auditor** on security issues
- Guide **architect** on architectural issues
