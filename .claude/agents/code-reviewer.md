...
- Work with **architect** on architectural concerns
- Collaborate with **security-auditor** for security reviews
- Support **performance-optimizer** on performance issues
- Assist **testing-expert** on test quality
