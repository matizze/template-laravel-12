    ...
    public function test_admin_can_create_user_via_modal(): void
    {
        ...
        $this->browse(function (Browser $browser) use ($admin) {
            $browser->loginAs($admin)
                ...
                ->type('#create-user-name', 'Novo Membro')
                ->type('#create-user-email', 'membro@example.com')
                ->type('#create-user-password', 'password123')
                ->type('#create-user-password-confirmation', 'password123')
                ->press('Salvar')
