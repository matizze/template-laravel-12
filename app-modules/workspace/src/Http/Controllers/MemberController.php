...
use Modules\Workspace\Http\Requests\InviteMemberRequest;
use Modules\Workspace\Http\Requests\UpdateMemberRoleRequest;
use Modules\Workspace\Models\Invitation;
use Modules\Workspace\Models\Member;
use Modules\User\Models\User;
use Modules\Workspace\Models\Workspace;
use Modules\Workspace\Notifications\WorkspaceInviteNotification;
...
class MemberController extends Controller
{
    public function index(Workspace $workspace): View
    {
        ...
        return view('workspace::dashboard.members.index', [
            'workspace' => $workspace,
            'members' => $members,
