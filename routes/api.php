...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::delete('/user/account', [SettingsController::class, 'destroy'])->name('user.account.destroy');
    ...
    Route::middleware('tenant')->group(function () {
        ...
        Route::delete('/tenants/{tenant}', [TenantSettingsController::class, 'destroy'])->name('tenant.destroy');
